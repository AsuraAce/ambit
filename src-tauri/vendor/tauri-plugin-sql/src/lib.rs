...
pub struct Builder {
    ...
    #[cfg(feature = "ambit-startup-trace")]
    startup_trace: Option<std::sync::Arc<startup_trace::Collector>>,
}

impl Builder {
    #[cfg(feature = "ambit-startup-trace")]
    #[must_use]
    pub fn startup_trace(mut self, collector: std::sync::Arc<startup_trace::Collector>) -> Self {
        self.startup_trace = Some(collector);
        self
    }
    pub fn new() -> Self {
        #[cfg(not(any(feature = "sqlite", feature = "mysql", feature = "postgres")))]
        ...
        PluginBuilder::<R, Option<PluginConfig>>::new("sql")
            ...
            .setup(|app, api| {
                ...
                run_async_command(async move {
                    ...
                    #[cfg(feature = "ambit-startup-trace")]
                    app.manage(startup_trace::TraceState(self.startup_trace.take()));
