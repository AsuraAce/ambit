...
pub fn get_legacy_migrations() -> Vec<Migration> {
    ...
    let migration23 = Migration {
        ...
        sql: "
            ...
            FROM images
            WHERE board_id IS NOT NULL
              AND board_id IN (SELECT id FROM collections);
        ",
        kind: MigrationKind::Up,
    };
    ...
    let migration26 = Migration {
        ...
        sql: "ALTER TABLE facet_cache ADD COLUMN is_manual INTEGER DEFAULT 0;",
        kind: MigrationKind::Up,
    };
    ...
    let migration29 = Migration {
        ...
        sql: "ALTER TABLE models ADD COLUMN thumbnail_mode TEXT;",
        kind: MigrationKind::Up,
    };
    ...
    let migration30 = Migration {
        ...
        sql: "ALTER TABLE facet_cache ADD COLUMN has_sidecar INTEGER DEFAULT 0;",
        kind: MigrationKind::Up,
    };
    ...
    vec![
        migration, migration2, migration3, migration4, migration5, migration6, migration7,
        migration8, migration9, migration10, migration11, migration12, migration13, migration14,
        migration15, migration16, migration17, migration18, migration19, migration20, migration21,
        migration22, migration23, migration24, migration25, migration26, migration27, migration28,
        migration29, migration30, migration31, migration32, migration37
    ]
}
