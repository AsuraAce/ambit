...
pub mod m76_thumbnail_retry_invalidation;
...
pub fn get_migrations() -> Vec<Migration> {
    ...
    migrations.push(m76_thumbnail_retry_invalidation::migration76());
...
mod tests {
    ...
    #[test]
    fn migrations_include_mainline_through_thumbnail_retry_invalidation_fix_76() {
    ...
    #[test]
    fn database_at_mainline_49_has_migrations_through_thumbnail_retry_invalidation_fix_76_pending()
    {
