...
### Load `docs/PDD.md` when the task involves:
- Application features, flows, and capabilities.
- UI rules or search behaviors.
...
|---|---|
| React components, hooks, UI work | 1. System Overview, 3. Architecture Boundaries |
| Zustand state, API data fetching | 4. State Management |
| SQLite schemas, db interactions | 5. Data Architecture (The Hybrid Model) |
| Rust backend, ComfyUI parsing | 6. ComfyUI Metadata Extraction System |

### Load `docs/TESTING.md` when the task involves:
- Writing or modifying tests.
- Adding a new backend function or heuristic logic.
