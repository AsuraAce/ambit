...
## Next Work
- Run the owner-acceptance desktop journey for InvokeAI owner-scope startup remediation Work Packages 2 and 3: first upgrade with prompt early progress, normal fast restart, multi-owner selection, temporary offline startup, retry, and scope change without missing or deleted Ambit records.
