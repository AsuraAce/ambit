...
## Next Work
- Run the owner-acceptance desktop journey for InvokeAI owner-scope startup remediation Work Package 2: first upgrade, normal restart, multi-owner selection, temporary offline startup, retry, and scope change without missing or deleted Ambit records.
