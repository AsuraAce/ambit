...
describe('pathUtils', () => {
    ...
    describe('directory helpers', () => {
        ...
        it('should detect when a path is inside a directory', () => {
            expect(isPathWithinDirectory('C:/Users/Artemis/AppData/Local/com.ambit.app/.thumbnails/file.webp', 'C:/Users/Artemis/AppData/Local/com.ambit.app')).toBe(true);
            expect(isPathWithinDirectory('D:/AI/art/output/image.png', 'C:/Users/Artemis/AppData/Local/com.ambit.app')).toBe(false);
        });
    });
});
