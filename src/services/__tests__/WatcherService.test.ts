...
describe('WatcherService', () => {
    ...
    it('skips native work in browser mock mode', async () => {
        ...
        expect(mockedListen).not.toHaveBeenCalled();
        expect(console.info).toHaveBeenCalledWith('[WatcherService] Native watcher unavailable in browser mock mode.');
    });
    ...
    it('logs stop failures after local watcher state has been cleared', async () => {
        ...
        expect(console.error).toHaveBeenCalledWith('Error stopping native watcher:', 'stop refused');
