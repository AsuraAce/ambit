...
export type ImageRecord = {
    id: string; path: string; width: number; height: number; fileSize: number; timestamp: number; metadataJson: string; thumbnailPath: string;
    /**
...
export type ScanResult = {
    width: number; height: number; size: number; modified: number; thumbnail: string;
    /**
     * Base64 encoded 32px WebP micro-thumbnail for instant previews
     */
    microThumbnail: string | null;
