...
export type ComfyWorkflowGraphReport = { source: string; nodeCount: number; nodes: ComfyWorkflowDisplayNode[]; edges: ComfyWorkflowDisplayEdge[]; selectedOutputNodeIds: string[]; rootSamplerNodeIds: string[]; outputAmbiguous: boolean }
