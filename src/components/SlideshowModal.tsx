...
export const SlideshowModal: React.FC<SlideshowModalProps> = ({
  ...
  }, [isPlaying, isOpen, duration, nextImage]);
  ...
  return (
    ...
    >
      ...
      {/* Progress Bar */}
      {isPlaying && (
          <div className="absolute top-0 left-0 h-1 bg-sage-500 z-50 transition-all ease-linear shadow-[0_0_10px_rgba(99,102,241,0.8)]"
               style={{ 
                   width: '100%', 
